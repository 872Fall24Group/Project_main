...
```{r,  fig.cap="PM2.5 Levels Across California (2022)", echo=FALSE}
# Load the shapefile
...
summary(model)
```
```{r, fig.cap="Relationship Between Poverty and PM2.5 (2022)", echo=FALSE, message=FALSE}
...
```{r, fig.cap="Relationship Between Minority Percentage and PM2.5 (2022)", echo=FALSE, message=FALSE}
...
```{r, fig.cap="Relationship Between Poverty and PM2.5 (2000)", echo=FALSE, message=FALSE}
...
```{r, fig.cap="Relationship Between Minority Percentage and PM2.5 (2000)", echo=FALSE, message=FALSE}
# Scatter Plot for Minority Percentage vs PM2.5
...
Intersectional approaches are needed to target areas where social vulnerabilities overlap with high pollution levels. 5) Future Research: Additional studies should explore causal mechanisms, focusing on factors such as proximity to pollution sources (e.g., industrial facilities or highways) and changes in county-level demographics.
